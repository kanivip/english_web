            ...
            <div class="css-e2tnif-ItemBody e1un6ycg4">
                ...
                <div class="benefits">
                    <div class="css-4kdkqr-FeatureList e1un6ycg7">
                        <ul>
                            <li><i class="fas fa-check dim"></i><span class="false false"> <span class="false dim">
                                        5
                                        Coin For Daily Rewards</span></li>
                            <li><i class="fas fa-check dim"></i><span class="false false"> <span class="false dim">
                                        Limit Of 3 Lessons/Day</span></li>
                            <li><i class="fas fa-check dim"></i><span class="false false"> <span class="false dim">
                                        Normal Support Time</span></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="benefits">
                <div class="css-17hbhb5-FeatureList e1un6ycg7">
                    <ul>
                        ...
                        <li><i class="fas fa-check red"></i><span class="false false"> <?php echo $vipBenefit ?>
                            </span>
                        </li>
                        <?php endforeach; ?>
                        <li><i class="fas fa-check red"></i><span class="false false"> Vip Duration: 7 Days</span>
                        </li>
                        <li>&nbsp</li>
                    </ul>
                </div>
                <button type="button" class="btn btn-primary" data-toggle="modal"
                    data-target=".bd-example-modal-lg.week">Buy now</button>
            </div>
        </div>
        <div class="css-1xqsvmv-ItemFooter e1un6ycg10"></div>
    </div>
            ...
            <div class="benefits">
                <div class="css-17hbhb5-FeatureList e1un6ycg7">
                    <ul>
                        ...
                        <?php endforeach; ?>
                        <li><i class="fas fa-check red"></i><span class="false false"> Vip Duration: 30 Days</span>
                        </li>
                        <li>&nbsp</li>
                    </ul>
                </div>
                <button type="button" class="btn btn-primary" data-toggle="modal"
                    data-target=".bd-example-modal-lg.month">Buy now</button>
            </div>
        </div>
        <div class="css-1xqsvmv-ItemFooter e1un6ycg10"></div>
    </div>
            ...
            <div class="benefits">
                <div class="css-17hbhb5-FeatureList e1un6ycg7">
                    <ul>
                        ...
                        <?php endforeach; ?>
                        <li><i class="fas fa-check red"></i><span class="false false"> Vip Duration: 365 Days</span>
                        </li>
                        <li><i class="fas fa-check red"></i><span class="false false"> Gifts From The Event</span>
                        </li>
                    </ul>
                </div>
                <button type="button" class="btn btn-primary" data-toggle="modal"
                    data-target=".bd-example-modal-lg.year">Buy now</button>
            </div>
        </div>
        <div class="css-1xqsvmv-ItemFooter e1un6ycg10"></div>
    </div>
...
<div class="modal fade bd-example-modal-lg week" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
    aria-hidden="true">
...
<div class="modal fade bd-example-modal-lg month" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <h5 class="modal-title" id="exampleModalLabel">New message</h5>
        <div class="modal-content" style="text-align: center;">
...
<div class="modal fade bd-example-modal-lg year" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <h5 class="modal-title" id="exampleModalLabel">New message</h5>
        <div class="modal-content" style="text-align: center;">
