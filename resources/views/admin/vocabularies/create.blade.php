            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="post" action="{{route('admin.vocabularies.store')}}"
                                enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                    <label for="inputText3" class="col-form-label">Name Vocabulary</label>
                                    <input id="inputText3" value="{{old('name')}}" name="name" type="text"
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="inputText3" value="{{old('meaning')}}" name="meaning" type="text"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6 p-2">
                                        <img class="img-thumbnail " id="image-target" />
                                    </div>
                                    @error('image')
                                    <div class="alert alert-warning alert-danger fade show">
                                        <strong>{{ $message }}</strong>
